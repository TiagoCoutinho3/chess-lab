...
export const BOT_AVATAR_EXPRESSIONS: Record<string, BotAvatarExpressionSet> = {
  rooki: {
    ...
    angry: { eyebrowsVariant: 'angry', mouthVariant: 'frown', eyesVariant: 'wide', animationVariant: 'none' },
    happy: { mouthVariant: 'bigSmile', eyesVariant: 'happy', animationVariant: 'none' },
  },
  pixel: {
    ...
    happy: { eyesVariant: 'happy', mouthVariant: 'smile', animationVariant: 'none' },
  },
  spark: {
  ...
  nova: {
    ...
    speakingClosed: { mouthVariant: 'smile', animationVariant: 'none' },
    angry: { eyebrowsVariant: 'angry', mouthVariant: 'frown', eyesVariant: 'wide', animationVariant: 'none' },
    happy: { mouthVariant: 'bigSmile', eyesVariant: 'star', animationVariant: 'none' },
  },
  zenith: {
    speakingOpen: { mouthVariant: 'laugh', animationVariant: 'none' },
    speakingClosed: { mouthVariant: 'flat', animationVariant: 'none' },
    angry: { eyebrowsVariant: 'angry', eyesVariant: 'side', animationVariant: 'none' },
    happy: { mouthVariant: 'smile', eyesVariant: 'soft', animationVariant: 'none' },
  },
  voxel: {
    speakingOpen: { mouthVariant: 'ooh', animationVariant: 'none' },
    speakingClosed: { mouthVariant: 'smirk', animationVariant: 'none' },
    angry: { eyebrowsVariant: 'angry', mouthVariant: 'frown', eyesVariant: 'wide', animationVariant: 'none' },
    happy: { mouthVariant: 'grin', eyesVariant: 'happy', animationVariant: 'none' },
  },
  bytemaster: {
    speakingOpen: { mouthVariant: 'speaker', animationVariant: 'none' },
    speakingClosed: { mouthVariant: 'line', animationVariant: 'none' },
  ...
  titan: {
    ...
    speakingClosed: { mouthVariant: 'flat', animationVariant: 'none' },
    angry: { eyebrowsVariant: 'angry', mouthVariant: 'frown', eyesVariant: 'wide', animationVariant: 'none' },
    happy: { mouthVariant: 'smile', eyesVariant: 'open', animationVariant: 'none' },
  },
  quantum: {
    speakingOpen: { mouthVariant: 'speaker', animationVariant: 'none' },
    speakingClosed: { mouthVariant: 'line', animationVariant: 'none' },
  ...
  sage: {
    ...
    speakingClosed: { mouthVariant: 'flat', animationVariant: 'none' },
    angry: { eyebrowsVariant: 'raised', eyesVariant: 'side', mouthVariant: 'frown', animationVariant: 'none' },
    happy: { mouthVariant: 'smile', eyesVariant: 'soft', animationVariant: 'none' },
  },
  magnusbot: {
    speakingOpen: { mouthVariant: 'smirk', animationVariant: 'none' },
    speakingClosed: { mouthVariant: 'flat', animationVariant: 'none' },
    angry: { eyebrowsVariant: 'angry', eyesVariant: 'wide', mouthVariant: 'frown', animationVariant: 'none' },
    happy: { mouthVariant: 'smile', eyesVariant: 'open', animationVariant: 'none' },
  },
};
